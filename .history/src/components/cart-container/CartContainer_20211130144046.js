      ...
      {modal && (
        <div className="modalBg">
          <form className="modalForm">
            <button className="button btn" onClick={showModal}>X</button>
            <label htmlFor="mail" aria-required>Ingrese su mail</label>
            <input type="text" id="mail" />
            <label htmlFor="name" aria-required>Ingrese nombre</label>
            <input type="text" id="name" />
            <label htmlFor="phone" aria-required>Ingrese su número de teléfono</label>
