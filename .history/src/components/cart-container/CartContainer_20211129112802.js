    ...
    <div>
      {itemsCart.length > 0 ? (
        <>
          ...
          <button className="button btn m-4" onClick={clearItems}>Limpiar carrito</button>
          <h2>Su total es de: ${sumar()}</h2>
          <button className="button btn m-2" onClick={finishPurchase}>Finalizar compra</button>
          {orderCreatedId && (
